...
@SpringBootTest(classes = CityServerMain.class, webEnvironment = SpringBootTest.WebEnvironment.NONE)
@TestPropertySource(properties = {"spring.cloud.config.failFast=false", "spring.data.mongodb.database=0"})
